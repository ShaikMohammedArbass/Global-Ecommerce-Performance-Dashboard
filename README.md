...
![Sales, Logistics & Financial Overview](screenshots/01-sales-logistics-financial-overview.png)

**Page 2 — Operations, Returns & Regional Leadership**

![Operations, Returns & Regional Leadership](screenshots/02-operations-returns-regional-leadership.png)

## Repository Contents

| File | Description |
|---|---|
| `Global-Ecommerce-Performance-Dashboard.pbix` | Power BI Desktop report file (open in Power BI Desktop) |
| `Global-Ecommerce-Dataset.xlsx` | Source dataset (Orders, Returns, People tables) |
| `Global-Ecommerce-Performance-Dashboard-Preview.pdf` | Static PDF export of both dashboard pages |
